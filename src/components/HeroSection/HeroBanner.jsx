      ...
      >
        <div className="right flex items-center justify-center p-5">
          <div className="w-fit skew-x-[8deg] skew-y-[-8deg] px-3 z-10 pt-3 pb-8 border shadow border-gray-200 bg-white">
            <img
              ...
              className="w-[12rem] h-[12rem] bg-white"
            />
          </div>
        </div>
        <div className="flex flex-col gap-8 lg:gap-5 lg:max-w-[50rem] px-4">
          <div className="left">
            ...
            <div className="text-3xl text-center tracking-wider lg:text-left text-neutral-800 font-medium pangolin">
              I’m a <span className="text-cyan-500">Front-end Engineer</span>{" "}
              who enjoys building clean, user-friendly interfaces. My focus is
              always on creating smooth, accessible, and responsive experiences.
            </div>
            <div className=""></div>
          </div>
